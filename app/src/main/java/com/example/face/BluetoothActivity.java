...
import com.example.face.Bluetooth.view.DeviceListAdapter;
...
public class BluetoothActivity extends AppCompatActivity {
    ...
    private List<com.calypso.bluelib.bean.SearchResult> mDevices;
    ...
    public void initBlueManager() {
        onSearchDeviceListener = new OnSearchDeviceListener() {
            ...
            @Override
            public void onSearchCompleted(List<com.calypso.bluelib.bean.SearchResult> bondedList, List<SearchResult> newList) {
